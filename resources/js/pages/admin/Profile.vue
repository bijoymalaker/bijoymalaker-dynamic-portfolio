          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="d-flex align-items-center gap-3">
                <img v-if="props.profile?.avatar_path"
                  :src="props.profile.avatar_path.startsWith('http') ? props.profile.avatar_path : `/storage/${props.profile.avatar_path}`"
                  class="rounded-circle object-fit-cover" style="width: 64px; height: 64px;" />
                <input type="file" @change="e => form.avatar = e.target.files[0]" class="form-control"
                  accept="image/*" />
              </div>
            </div>
