          ...
          <tbody>
            <tr v-for="skill in skills" :key="skill.id">
              ...
              <td class="align-middle">
                ...
                <span class="small text-muted">{{ skill.percentage }}%</span>
              </td>
              <td class="align-middle">
                <div class="d-flex gap-2">
                  <button @click="editItem(skill)" class="btn btn-link text-primary p-0 text-decoration-none">Edit</button>
                  <Link :href="`/admin/skills/${skill.id}`" method="delete" as="button" class="btn btn-link text-danger p-0 text-decoration-none">Delete</Link>
                </div>
              </td>
            </tr>
          </tbody>
